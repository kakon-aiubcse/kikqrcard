  ...
  return (
    <div className=" min-h-screen flex flex-col mb-32 w-screen xs:w-screen ">
      <div className=" flex flex-col items-center justify-center pr-72 xs:pr-0">
        <span className="text-5xl font-cp p-4 m-4 text-brand font-bold lp:text-4xl tb:text-3xl xs:text-4xl">
          Contact
        </span>
      </div>
      ...
      <div
       ...
       xs:pl-4 xs:grid-cols-1 lp:grid-cols-2 tb:grid-cols-1 xb:grid-cols-3 xb:gap-24 xb:p-10 xb:pr-[430px] xb:m-1"
      >
